...
| 05 | [Changelog & Versioning](05-changelog-versioning.md) | DONE | CHANGELOG.md (v1.18–v1.22), cliff.toml, version package, --version flag, goreleaser ldflags |
| 06 | [Discoverability & Marketing](06-discoverability.md) | IN PROGRESS | Code done (README, docs, elastic, topics, AH metadata, launch drafts). Needs: screencast, HN/Reddit posts, dev.to, Artifact Hub registration |
